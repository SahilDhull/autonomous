...
def run_test(ego_init_speed_m_s=10.0, ego_x_pos=20.0, pedestrian_speed=3.0, sim_duration=6000, for_matlab=False):
    ...
    # target_pos_list = [[500.0, 0.0], [0.0,0.0]]
    ...
    sim_config.world_file = '../Webots_Projects/worlds/verify.wbt'
