...
def run_test(ego_init_speed_m_s=10.0, ego_x_pos=20.0, pedestrian_speed=3.0, sim_duration=80000, for_matlab=False):
    ...
    distance = 0.0
    RadiusofCurvature = 50.0
    target_pos_list = []
    for distance in np.arange(0, 2*math.pi*RadiusofCurvature,5):
        theta = distance/RadiusofCurvature
        target_pos_list.append([500.0-RadiusofCurvature*math.sin(theta), RadiusofCurvature*math.cos(theta)-RadiusofCurvature])
