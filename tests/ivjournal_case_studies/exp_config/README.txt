...
$EXPERIMENT_NAME$_CA_$n$_way.csv : The ACTS output covering array information. Covering array covers $n$-way combinations. For mixed strength, it can be $n$_$m$. The csv file contains a header with the covering array generation setup. In its body, it contains the generated covering array toget with the parameter names as column titles.
