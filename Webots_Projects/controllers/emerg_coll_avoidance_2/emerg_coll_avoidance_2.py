"""Defines emerg_coll_avoidance_2 controller
----------------------------------------------------------------------------------------------------------
...
from Sim_ATAV.vehicle_control.emerg_coll_avoidance_2.emerg_coll_avoidance_2 import EmergencyCollAvoidance2


def run(input_args):
    """For running controller from "vehicle_controller"."""
    controller = EmergencyCollAvoidance2(input_args)
    controller.run()

def main():
    """For running the controller directly from Webots
    without passing it as a parameter to vehicle_controller"""
    controller = EmergencyCollAvoidance2(sys.argv)
    controller.run()
