"""Defines trial_controller controller
----------------------------------------------------------------------------------------------------------
...
from Sim_ATAV.vehicle_control.trial_controller.trial_controller import TrialController


def run(input_args):
    """For running controller from "vehicle_controller"."""
    controller = TrialController(input_args)
    controller.run()
...
def main():
    ...
    controller = TrialController(sys.argv)
    controller.run()
