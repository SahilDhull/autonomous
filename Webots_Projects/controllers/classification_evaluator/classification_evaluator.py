"""Defines classification_evaluator controller
----------------------------------------------------------------------------------------------------------
...
from Sim_ATAV.vehicle_control.classification_evaluator.classification_evaluator import ClassificationEvaluator


def main():
    """For running the controller directly from Webots
    without passing it as a parameter to vehicle_controller"""
    controller = ClassificationEvaluator(sys.argv)
    controller.run()
