"""Defines simple_classifier controller
----------------------------------------------------------------------------------------------------------
...
from Sim_ATAV.vehicle_control.simple_classifier.simple_classifier import SimpleClassifierControl


def run(input_args):
    """For running controller from "vehicle_controller"."""
    controller = SimpleClassifierControl(input_args)
    controller.run()
...
def main():
    ...
    controller = SimpleClassifierControl(sys.argv)
    controller.run()
