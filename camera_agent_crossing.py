...
def run_test(ego_init_speed_m_s=10.0, ego_x_pos=20.0, pedestrian_speed=3.0, sim_duration=13000, for_matlab=False):
    ...
    target_pos_list = [[380.0, 1.88], [315.0, 2.8], [304.5, 3.5], [302.88, 10.0], [300.0, 150.0]] #left turn
