...
def run_test(ego_init_speed_m_s=10.0, ego_x_pos=20.0, pedestrian_speed=3.0, sim_duration=8500, for_matlab=False):
    ...
    target_pos_list = [[380.0, 1.88], [315.0, 1.88], [304.0, 3.2], [302.88, 10.0], [300.0, 150.0]] #left turn
