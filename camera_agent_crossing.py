...
def run_test(ego_init_speed_m_s=10.0, ego_x_pos=20.0, pedestrian_speed=3.0, sim_duration=40000, for_matlab=False):
    ...
    # vhc_obj.sensor_array[-1].sensor_type = 'Camera' # 'Radar' #'DelphiESR'
    # vhc_obj.sensor_array[-1].sensor_location = WebotsSensor.TOP
    # vhc_obj.sensor_array[-1].add_sensor_field('name', '"camera2"')
    ...
    # -------- LEFT TURN ----------
    # target_pos_list = [[380.0, 1.88], [315.0, 2.8], [305.0, 3.5], [303.0, 5.0], [302.88, 10.0], [300.0, 150.0]] #left turn
    
    # -------- STRAIGHT -----------
    target_pos_list = [[380.0, 1.88], [115.0, 1.88]]
