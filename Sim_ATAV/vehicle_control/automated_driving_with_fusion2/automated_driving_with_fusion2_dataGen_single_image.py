...
file_path = '../../../images/new_correction/left/'
...
class PathAndSpeedFollower(BaseCarController):
    ...
    def __init__(self, controller_parameters):
        ...
        self.camera = None
        self.camera_device_name2 = 'camera2'
        self.camera2 = None
    ...
    def start_devices(self):
        ...
        # self.camera2 = self.getCamera(self.camera_device_name2)

        if self.camera is not None:
            self.camera.enable(self.CLASSIFIER_PERIOD_MS)

        # if self.camera2 is not None:
        #     self.camera2.enable(self.CLASSIFIER_PERIOD_MS)
                ...
                if cur_time_ms<3010:
                    ...
                    if cur_time_ms%100==0:
                        ...
                        if save:
                            ...
                            # self.camera2.saveImage(image_path+img_name,1)
                            img_cnt = img_cnt + 1
