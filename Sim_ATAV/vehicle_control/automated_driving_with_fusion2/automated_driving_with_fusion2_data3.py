...
file_path = '../../../images/3camera/correction_straight/'
            ...
            if self.is_direct_speed_control:
                ...
                if cur_time_ms<3010:
                    ...
                    if cur_time_ms%100==0:
                        ...
                        if save:
                            # --- Left ---
                            img_name = "img"+str(img_cnt)+"_1.png"
                            self.cameral.saveImage(image_path+img_name,1)
                            # --- Center ---
                            img_name = "img"+str(img_cnt)+"_2.png"
                            self.camerat.saveImage(image_path+img_name,1)
                            # --- Right ---
                            img_name = "img"+str(img_cnt)+"_3.png"
                            self.camerar.saveImage(image_path+img_name,1)
                            img_name = "img"+str(img_cnt)+".png"
                            img_cnt = img_cnt + 1
                            data_dict[img_name] = [cur_speed_ms,target_throttle[time_index],control_steering, cur_position, cur_yaw_angle, heading]
                        # print(heading)
