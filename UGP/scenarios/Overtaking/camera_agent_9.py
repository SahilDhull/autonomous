...
def run_test(ego_init_speed_m_s=10.0, ego_x_pos=20.0, pedestrian_speed=3.0, sim_duration=24000, for_matlab=False):
    ...
    sim_config.world_file = '../Webots_Projects/worlds/our_world_9.wbt'
